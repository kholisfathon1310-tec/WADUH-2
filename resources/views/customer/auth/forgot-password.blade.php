    ...
    <div class="login-shell">
        <div class="login-visual">
            ...
            <div>
                ...
                <p class="lv-sub">Masukkan email Pemesan Anda, kami kirimkan tautan untuk membuat kata sandi baru.</p>
                <ul class="lv-points">
        ...
        <div class="login-form-panel">
            <div class="login-form-head">
                ...
                <p>Masukkan email akun Pemesan Anda untuk menerima tautan ubah kata sandi.</p>
            </div>
